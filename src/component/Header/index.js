    ...
    <header className={cx("wrapper-header")}>
      <div className={cx("inner-header")}>
        ...
        <div className={cx("btns")}>
          ...
          <button
            className={cx("btn btnsignin", state.isLogin ? "off" : "turn")}
            onClick={() => navigate("/login")}
          >
            Đăng nhập
          </button>
          <button className={cx("btnavatar", state.isLogin ? "turn" : "off")}>
            <BsFillPersonFill
              className={cx("avatar")}
              onClick={() => navigate(`/account/history-make-appointment`)}
            />
          </button>
        </div>
      </div>
