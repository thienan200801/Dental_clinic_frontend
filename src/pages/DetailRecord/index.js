...
function DetailRecord() {
  ...
  const url = `http://localhost:3000/api/authentication/get-patient-detail`;
  useEffect(() => {
  ...
  const urlRec = `http://localhost:3000/api/medical_record`;
  useEffect(() => {
    if (param.recID) {
  ...
  const urldoc = "http://localhost:3000/api/authentication/get-profile";
  const data = {
  ...
  function callApiAddRecord() {
    const url = "http://localhost:3000/api/add_medical_record";
    const data = {
      d_id: dID,
      p_id: param.userID,
      rec_dease: dease,
  ...
  function callApiUpateRecord() {
    const url = "http://localhost:3000/api/record/update";
    const data = {
