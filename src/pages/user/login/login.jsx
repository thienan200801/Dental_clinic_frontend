...
export default function Login() {
  ...
  return (
    <div className={cx("wrapperFormLogin")}>
      ...
      <form className={cx("FormLogin")} onSubmit={(e) => handleSubmit(e)}>
        ...
        {isSubmit && !usernameRef.current.value && (
          <label className="warning">
            {" "}
            <RiErrorWarningFill /> Chưa điền thông tin tài khoản!
          </label>
        )}
        ...
        {isSubmit && !passwordRef.current.value && (
          <label className="warning">
            {" "}
            <RiErrorWarningFill /> Chưa điền mật khẩu!
          </label>
        )}
        ...
        <button
          type="submit"
          className={cx("btn btn-info CustomSubmit")}
        ...
        <a className={cx("CustomForgetPassword")}>
          <div className={cx("CustomForgetPasswordText")}>
      ...
      {isSubmit &&
        ...
        isLoginSS && (
          <label className="warning">
            {" "}
            <RiErrorWarningFill /> Đăng nhập thất bại!
          </label>
        )}
    </div>
  );
